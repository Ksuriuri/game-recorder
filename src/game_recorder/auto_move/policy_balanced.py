...
class BalancedRadiusPolicy:
    ...
    def step(
        ...
        *,
        ...
        elif clock >= self._hold_until or self._current is None:
            self._resample(clock, pose=pose, force_stuck=clock < self._escape_until)
    ...
    def _resample(
        ...
        *,
        ...
        self._hold_until = clock + self._sample_hold()
